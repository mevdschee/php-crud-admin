...
{{for:record:records}}
    <tr>
        ...
        <td style="border-right: 2px solid #ddd; width: 40px;">
            <a class="btn btn-default btn-xs" href="{{base}}/{{table}}/read/{{record.name}}">+</a>
        </td>
        <td>{{record.type}}</td>
...
<tbody>
    ...
    <tr>
        <td>
            ...
            {{if:record.fk}}
                <a class="btn btn-default btn-xs" href="{{base}}/{{record.fk}}/list"> + </a>
            {{else}}
                &nbsp;
            {{endif}}
        </td><td>
...
// file: src/Tqdev/PhpCrudAdmin/Column/SpecificationService.php
namespace Tqdev\PhpCrudAdmin\Column {
